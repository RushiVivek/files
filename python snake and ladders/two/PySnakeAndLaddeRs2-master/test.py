...
def playit(dice, roll_dice, playing, player1, play, player2, p, p2, playin, k):
    mep = dice
    dic = dice
    while dice == dic:
        dic = roll_dice()
        ...
        if mep == 5:
            ...
            if (p + dice + 1) > 100:
                ...
                if play == 1 or playin == player1:
                    ...
                    p += dice + 1
    k = 0
    return dice, playing, player1, play, player2, p, p2, playin, k
                ...
                if pygame.mouse.get_pressed() == (1, 0, 0):
                    if (pygame.mouse.get_pos()[0] in range(50, 150)) & (pygame.mouse.get_pos()[1] in range(350, 450)):
                        if (k > 10) | (rolled == False):
                            rolled = True
                            dice, playing, player1, play, player2, p, p2, playin, k = playit(dice, roll_dice, playing, player1, play, player2, p, p2, playin, k)
